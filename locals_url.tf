  ...
  zia_url_filtering_rules = [
    {
      ...
      order       = 1
      description = "Block access to social media during work hours"
      state       = "DISABLED"
      action      = "BLOCK"
      rank        = 7
      ...
      # Workload groups
      workload_groups = []
      # Example: [{ id = "12345", name = "Production Workloads" }]
    },
    {
      name        = "Terraform / Allow Microsoft Services"
      order       = 2
      description = "Allow access to Microsoft cloud services"
      state       = "DISABLED"
      action      = "ALLOW"
      rank        = 7
      ...
      # Categories
      url_categories   = ["MICROSOFT_ONLINE_SERVICES"]
      source_countries = []
      ...
      validity_end_time     = null
      validity_time_zone_id = null
      ...
      # Other settings
      block_override            = false
      end_user_notification_url = null
      workload_groups           = []
    }
  ]
